...
function AddBasements(props) {
    ...
    var descriptionHandler = function descriptionHandler(e) {
        if (e.currentTarget.value.length <= 1 || e.currentTarget.value.length > 500) setDescriptionError("Must be at least 2 and at most 500- Current = " + e.currentTarget.value.length + " words");else setDescriptionError('');
    };
